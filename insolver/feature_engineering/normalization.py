...
class Normalization:
    ...
    Parameters:
        method (str): Normalization method. Values `standard`, `minmax`, `robust`, `normalizer`, `yeo-johnson`, `box-cox`,
         `log` are supported. If None, values in column_method will only be transformed.
    ...
    def transform(self, data):
        ...
        It creates new `pandas.DataFrame` as a copy of the original data and transformes either the selected or all columns.

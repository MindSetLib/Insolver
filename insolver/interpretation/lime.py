...
class LimeExplanation(InterpretBase):
    ...
    Parameters:
        ...
        x (pandas.Dataframe, numpy.ndarray): Training data. If x is pandas.Dataframe, it is converted to the numpy.ndarray.
    ...
    def __init__(self, estimator, x, mode, features_names, categorical_features=None,
    ...
    def show_explanation(self, instance, result_type = 'show_in_notebook', file_path = None, label = None):
        ...
        Parameters: 
            ...
            result_type (str): Type of the result. Values `html`, `list`, `map`, `file`, `show_in_notebook` are supported.
        ...
        explanation = self.model.explain_instance(
            data_row = instance, 
            predict_fn = predict_fn
        )
        
        if self.mode == 'classification' and result_type == 'list' and label == None:
